package MultiTread.Synchronized;

public class SynchronizedThreadsFailed {
    //用object当锁，不同thread用不同锁去访问同一变量，会失效。
    public static void main(String[] args) throws  InterruptedException{
        ...
        //永远在变，因为加减锁的对象不同
        System.out.println("永远在变，因为加减锁的对象不同 -> " + Counter1.studentCount);

        //永远为0， 用的是同一把锁
        System.out.println("永远为0， 用的是同一把锁 -> " + Counter1.teacherCount);
