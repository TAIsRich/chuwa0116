package com.chuwa.learn.hw6.t08_multithreading.c01_creat;
...
public class Main {
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        // use extends thread
        Thread t = new com.chuwa.tutorial.t08_multithreading.c01_creat.MyThread();
        ...
        Thread t2 = new Thread(new com.chuwa.tutorial.t08_multithreading.c01_creat.MyRunnable());
        t2.start();
        ...
        Callable<String> callable = new com.chuwa.tutorial.t08_multithreading.c01_creat.MyCallable();
