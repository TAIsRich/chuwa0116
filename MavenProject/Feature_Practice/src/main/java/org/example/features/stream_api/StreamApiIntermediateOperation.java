...
public class StreamApiIntermediateOperation {
    ...
    public void testDistinct(){
        ...
        List<Integer> cc = Arrays.asList(1, 2, 3, 3, 4, 4, 5);
        List<Integer> ans = cc.stream().distinct().collect(Collectors.toList());
    }
    ...
    public void testFlatMap(){
        ...
        Stream<String> stringStream = listsOfStrings.stream().flatMap(a -> a.stream());
