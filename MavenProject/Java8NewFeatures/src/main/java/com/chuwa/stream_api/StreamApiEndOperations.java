...
public class StreamApiEndOperations {
	private final List<Employee> EMPLOYEES = Arrays.asList(new Employee(),new Employee(),new Employee(),new Employee());
	class Employee{
		...
		public Employee(int a1,String name,int a2,int a3){
			this.a1=a1;
			this.a2=a2;
			this.a3=a3;
			this.name = name;
	...
	public void testToMap() {
		Map<Integer, Integer> collect = EMPLOYEES.stream()
