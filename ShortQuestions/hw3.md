...
```
### 2.Obtain a list of product with category = "Books" and price > 100 (using Predicate chaining for filter
```
    @Test
...
### 3.Obtain a list of product with category = "Books" and price > 100 (using BiPredicate for filter
```
    @Test
...
### 6.Get the 3 cheapest products of "Books" category
```
    @Test
...
### 9.Calculate the total lump of all orders placed in Feb 2021 (using reduce with BiFunction)
```
@Test
...
### 10.Calculate the average price of all orders placed on 15-Mar-2021
```
    @Test
...
### 11.Obtain statistics summary of all products belong to "Books" category
```
    @Test
...
### 12.Obtain a mapping of order id and the order's product count
```
    @Test
...
### 13.Obtain a data map of customer and list of orders
```
    @Test
...
### 14.Obtain a data map of customer_id and list of order_id(s)
    @Test
...
### 15.Obtain a data map with order and its total price
```
    @Test
...
### 16.Obtain a data map with order and its total price (using reduce)
```
@Test
...
### 17.Obtain a data map of product name by category
```
    @Test
...
### 18.Get the most expensive product per category
```
@Test
...
### 19.Get the most expensive product (by name) per category
```
@Test
